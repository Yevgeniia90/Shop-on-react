...
const Allcategories = ({ product, products }) => {
    ...
    <div className="ProductList">
      <div className="productInfo">
        ...
        <div className="likeButton">
          {likes.find(p => product.id === p.id) ? (
            <FavoriteIcon className='red' onClick={removeHandleClick} />
          ) : (
            <FavoriteBorderIcon onClick={addHandleClick} />
          )}
        </div>
      </div>
      <div className="ProductDetails">
        ...
        <div className='BuyRate'>
          ...
          <Rate allowHalf className='Rate' value={product.rating.rate} />
        </div>
        <div>
